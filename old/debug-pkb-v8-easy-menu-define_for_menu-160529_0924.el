...
"
  (let* ((outp-symb-pref-str
	...
	'("Overlap-Menu"
	  ["Overlap cmd a" overlap-cmd-a]
	  ["Overlap cmd b" overlap-cmd-b]))
      ...
      (cl-loop for i to 2
		...
		`(easy-menu-define nil ,(nth i kms)
		   ...
		   '(,("Nonoverlap-Menu-" i-str)
		     [,(prin1-to-string cmd-a) ,cmd-a]
		     [,(prin1-to-string cmd-b) ,cmd-b]))))
      (cl-loop
       for i to 2
       for km = (nth i kms)
       do
       
       (define-key km [menu-bar] (make-sparse-keymap "menu-bar"))

       ;; define overlapping menu parts
       (define-key km [menu-bar overlap-sub-menu]
	 (cons "overlap-sub-menu" (make-sparse-keymap "overlap-sub-menu")))
       (define-key km [menu-bar overlap-sub-menu overlap-item1]
	 '(menu-item "overlap-item1" overlap-item1-defn))
       (define-key km [menu-bar overlap-sub-menu overlap-item2]
	 '(menu-item "overlap-item2" overlap-item2-defn))
       
       ;; define nonoverlapping menu parts
       for i-str = (prin1-to-string (1+ i))
       for nonoverlap-menu-symb = (jsts "nonoverlap-km" (1+ i))
       for nonoverlap-menu-name = (prin1-to-string nonoverlap-menu-name)
       
       (define-key km (vector 'menu-bar nonoverlap-menu-symb)
	 (cons nonoverlap-menu-name (make-sparse-keymap nonoverlap-menu-name)))

       for j from 1 to 2
       for nonoverlap-item-symb = (jsts nonoverlap-menu-symb "-item" j)
       for nonoverlap-item-name = (prin1-to-string nonoverlap-item-symb)
       do
       (define-key km (vector 'menu-bar nonoverlap-menu-symb nonoverlap-item-symb)
	 '(menu-item nonoverlap-item-name
		     (jsts nonoverlap-item-name "-defn") :help (concat nonoverlap-item-name "-help")))
       (define-key sub-menu [somebinding1] '(menu-item "zamboni" (lambda () (interactive) (insert "22")) :help "blah blah2")))
